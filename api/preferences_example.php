...
/* web rtc */
define('WEBRTC_FIELDS_CAPTURE', "id, date, floor(micro_ts /1000) as milli_ts, micro_ts,session_id as callid, method,source_ip,source_port,destination_ip,destination_port,correlation_id,proto,family,type,node");
