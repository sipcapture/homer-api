...
/* web rtc */
define('WEBRTC_FIELDS_CAPTURE', "id, date, floor(micro_ts /1000) as milli_ts, micro_ts,correlation_id as callid, '' as callid_aleg, method, source_ip,source_port,destination_ip,destination_port,correlation_id,proto,family,type,node");
